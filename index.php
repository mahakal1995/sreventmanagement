...
<!-- Header Section End -->
    ...
    <div class="section1">
        ...
        <div class="box1">
            <p id="inner_p1">EDUCATION IS MOST POWERFUL WEAPON</p>
            <p id="inner_p2">WHICH CAN USE TO CHANGE THE WORLD</p>
        </div>
    </div>
    ...
    <div class="section2">
        ...
        <p id="sec2_p2">You will find courses that enhance your knowledge</p>
    </div>
    ...
    <div class="section5">
        ...
        <div class="sec5">
            <p class="sec5_p1">Arctik Circle </p>
            <p class="sec5_p2"><span>The Digital Revolution</span></p>
        </div>
    </div>
