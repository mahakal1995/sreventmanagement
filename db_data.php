...
//purpose:add saturday as working day
        ...
        $allow=1;
                        ...
                        if(($date==$sat_fourth && (!in_array($sat_fourth,$working_day))) || ($date ==$sat_second  && (!in_array($sat_second,$working_day))) || in_array($date,$holiday))
                        {
...
//                       Change : Make sunday as working day
                        if($dt->format('l')=="Sunday" && !in_array($date, $working_day))
                        {
                           $allow=0;
                        }
                        echo $allow;
