...
<body id="crs_bdy">
    ...
    <div class="crs_sidebar">
        <div class="crs_video_bar">
            ...
            ?>
                    <video src="videos/<?php echo $vid;
                                    }
                                } ?>" class="crs_sbr_video" width="100%" ; height="100%" ;>
        ...
        <div class="crs_sbr_body">
            ...
            ?>
            <video  style="top: -200px; position: relative" width="320" height="240" controls>
                <source src="./videos/python.mp4" type="video/mp4">
                Your browser does not support the video tag.
            </video>
            <span class="crs_sbr_price crs_mr"><span class="crs_prce"> <b>₹</b> <?php if (isset($crs_prcl)) {
                                                                                    echo $crs_prcl;
                                                                                } ?></span> &nbsp;<span class="crs_discount">₹<?php if (isset($crs_org_prcl)) {
                                                                                                                                                                                echo $crs_org_prcl;
                                                                                                                                                                            } ?></span> &nbsp;<span class="crs_off"><?php if (isset($prct2)) {
                                                                                                                                                                                                                                                                            echo $prct2;
                                                                                                                                                                                                                                                                        } ?> off</span></span>
            <span class="crs_sbr_tme_lft crs_mr"> <i class="fas fa-clock"></i> </span>
            ...
            ?>
                                    <script>
                                        var add = document.getElementById('add_directory');
                            ...
                            ?>
                            <script>
                                var add = document.getElementById('add Directory');
                                var att = document.createAttribute('disabled');
                                att.value = 'disabled';
                                var att2 = document.createAttribute('style');
            ...
            if (isset($crs_token) && isset($uemail)) {
                if ($db->select('user_courses', "courses_en", null, "courses_en ='$crs_token' AND ucmail = '$uemail'")) {
                    ...
                    if ($cntt == 0) {
                        ...
                        <script>
                            var Free_nw = document.getElementById('Free');
                            var att = document.createAttribute('disabled');
                            att.value = 'disabled';
                            var att2 = document.createAttribute('style');
                            att2.value = 'rgb(236, 82, 82,0.2)';
                            Free.setAttributeNode(att);
                            Free.setAttributeNode(att2);
                        </script>
            <?php }
                }
            }
            ?>
            <a href="./checkout?crs_id=<?php if (isset($crs_token)) {
                                            echo $crs_token;
                                        } ?>" class="crs_sbr_btn buy_btn crs_mr" id="buy_nw">Buy Now</a>
            <span class="crs_sbr_mny crs_mr">BUSSINESS COURSE</span>
            <div class="crs_sbr_div crs_mr">
                <span class="crs_sbr_ttl crs_mr">This course includes:</span>
                <span class="crs_sbr_1 crs_mr"><i class="fas fa-file-video"></i>&nbsp; <span><?php if (isset($crs_durl)) {
                                                                                                    echo $crs_durl;
                                                                                                } ?></span> hours on-demand video</span>
                <span class="crs_sbr_2 crs_mr"><i class="fas fa-file-pdf"></i>&nbsp; <span><?php if (isset($crs_artl)) {
                                                                                                echo $crs_artl;
                                                                                            } ?></span> articles</span>
                <span class="crs_sbr_3 crs_mr"><i class="fas fa-download"></i>&nbsp; <span><?php if (isset($crs_dnrl)) {
                                                                                                echo $crs_dnrl;
        ...
        <div class="crs_sbr_end">
            ...
            <span class="crs_sbr_end_sub crs_mr">Get your team access to 100+ top arctik circle education courses anytime, anywhere.</span>
            <a href="signup" class="crs_sbr_btn buy_btn crs_mr">TRY ARCTIK CIRCLE</a>
        </div>
    </div>
    <!-- Sidebar End  -->
    ...
    <div class="c_top_header">
        <div class="c_top_sec1">
            <span class="crs_title crs_cmm"><?php if (isset($crs_nme)) {
                                                echo $crs_nme;
                                            } ?></span>
            <span class="crs_tag crs_cmm"><?php if (isset($crs_tagl)) {
                                                echo $crs_tagl;
                                            } ?></span>
            <?php
            ...
            ?>
            <span class="crs_line1 crs_cmm"><span class="bst_seller">Best Seller</span> <span class="sec_crs_ratings"><?php echo $rat_round; ?> (Ratings)</span> <span class="auth_students"><?php if (!empty($cntc)) {
                                                                                                                                                                                                    echo $cntc . " " . "students";
                                                                                                                                                                                                } ?></span></span>
            <span class="author crs_cmm">Created By <a href="#"><?php if (isset($iname)) {
                                                                    echo $iname;
                                                                } ?></a></span>
            <span class="crs_line2 crs_cmm"><span class="last_updated"><i class="fas fa-exclamation-circle"></i><?php if (isset($lst_upt)) {
                                                                                                                    echo $lst_upt;
                                                                                                                } ?></span> <span class="crs_lang"><i class="fas fa-globe"></i> <?php if (isset($crs_lngl)) {
                                                                                                                                                                                                                                echo $crs_lngl;
                                                                                                                                                                                                                            } ?></span> <span class="crs_cc"><i class="fas fa-closed-captioning"></i> CC</span></span>
    ...
    <div class="crs_sec2">
        <ul class="crs_sec2_ul">
            <p class="crs_Sec2_ttl">Mayank Rai(CEO)</p>
    ...
    <div class="crs_sec7 crs_cmm_sec">
        ...
        <p class="crs_Sec7_ins"><?php if (isset($iname)) {
                                    echo $iname;
                                } ?></p>
        ...
        <div class="crs_sec7_ul">
            <div class="crs_sec7_ul2">
                <div class="crs_sec7_img_div">
                    <img src="images/instructors/<?php if (isset($ipic)) {
                                                        echo $ipic;
                                                    } ?>" alt="" class="crs_sec7_img">
                </div>
                <div class="crs_sec7_det">
                    ...
                    <p><i class="fas fa-play-circle crs_sec7_icons"></i>&nbsp; &nbsp;<?php if (isset($crs_count)) {
                                                                                            echo $crs_count;
                                                                                        } ?></p>
                </div>
            </div>
            <div class="crs_sec7_des"><?php if (isset($idesc)) {
                                            echo $idesc;
                                        } ?></div>
        </div>
    </div>
    ...
    <div class="crs_sec8 crs_cmm_sec">
        ...
        <div class="crs_sec8_div">
            ...
            <div class="crs_sec8_div2">
                <progress value="<?php if (isset($avgg['4'])) {
                                        echo $avgg['4'];
                                    } else {
                                        echo '0';
                                    } ?>" max="<?php if (isset($avgg_cnt)) {
                                                                                                                echo $avgg_cnt;
                                                                                                            } else {
                                                                                                                echo '5';
                                                                                                            } ?>"></progress>
                <progress value="<?php if (isset($avgg['3'])) {
                                        echo $avgg['3'];
                                    } else {
                                        echo '0';
                                    } ?>" max="<?php if (isset($avgg_cnt)) {
                ...
                <progress value="<?php if (isset($avgg['2'])) {
                                        echo $avgg['2'];
                                    } else {
                                        echo '0';
                                    } ?>" max="<?php if (isset($avgg_cnt)) {
                ...
                <progress value="<?php if (isset($avgg['1'])) {
                                        echo $avgg['1'];
                                    } else {
                                        echo '0';
                                    } ?>" max="<?php if (isset($avgg_cnt)) {
                ...
                <progress value="<?php if (isset($avgg['0'])) {
                                        echo $avgg['0'];
                                    } else {
                                        echo '0';
                                    } ?>" max="<?php if (isset($avgg_cnt)) {
            ...
            <div class="crs_sec8_div3">
                <p>5 &nbsp;<?php $c = 0;
                            while ($c < 5) {
                                echo "<span class='fas fa-star' style='color:#fd4; stroke:#444; stroke-width:20px;'></span>";
                                $c++;
                            } ?></p>
                <p>4 &nbsp;<?php $c = 0;
                            while ($c < 4) {
                ...
                ?>
                        <div class="crs_review">
                            ...
                            <div class="crs_review_cmmt">
                                ...
                                <span class="crs_review_rt"><span class="crs_review_rat"><?php $i = 0;
                                                                                            while ($i < $cmt_ratings) {
                                                                                                echo "<span class='fas fa-star' style='color:#fd4; stroke:#444; stroke-width:20px;'></span> ";
                                                                                                $i++;
                                                                                            } ?> <span class="crs_review_ratings"><?php echo $cmt_time; ?></span></span></span>
