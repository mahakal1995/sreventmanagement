 ...
 * @method integer            getCompensate()             Returns the current record's "compensate" value
 ...
 * @method integer            setCompensate()             Returns the current record's "compensate" value
...
abstract class BaseHoliday extends sfDoctrineRecord
{
 ...
 // kartik new created for holiday        
         $this->hasColumn('compensate', 'integer', 1, array(
             'type' => 'integer',
             'default' => '0',
             'length' => 1,
             ));
