 ...
 * @property string $rate_per_hours
 ...
 * @method string                     getRatePerHours()              Returns the current record's "rate_per_hours" value
 ...
 * @method Employee                  setRatePerHours()              Sets the current record's "rate_per_hours" value
...
//        kartik with here serach with rate_per_hours
        $this->hasColumn('rate_per_hours', 'string', 4, array(
             'type' => 'string',
             'default' => '',            
             'length' => 50,
             ));       
