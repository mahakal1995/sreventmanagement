 ...
 * @method integer         getDuration_ot()      Returns the current record's "duration_ot" value
 ...
 * @method TimesheetItem   setOtDuration()      Sets the current record's "duration_ot" value
 ...
 */
    ...
    /**        
        By:kartik gondalia
        Date:23-03-2013
        Purpose:added getOtDuration,setOtDuration,duration_ot add this fields
...
abstract class BaseTimesheetItem extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('duration_ot', 'integer', null, array(
             'type' => 'integer',
             ));
