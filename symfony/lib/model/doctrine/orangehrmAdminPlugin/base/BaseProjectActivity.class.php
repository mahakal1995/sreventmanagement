...
//        jaydeep add for estimate_time
        $this->hasColumn('estimate_time', 'string', 110, array(
             'type' => 'string',
             'length' => 110,
             ));
        
//kartik for add field in activity        
        $this->hasColumn('diu_id as diuId', 'integer', 11, array(
             'type' => 'integer',           
             'notnull' => false,
             'length' => 11,
             ));
        
        $this->hasColumn('activity_code', 'string', 110, array(
             'type' => 'string',           
             'length' => 110,
             ));
//kartik for add field in activity        
