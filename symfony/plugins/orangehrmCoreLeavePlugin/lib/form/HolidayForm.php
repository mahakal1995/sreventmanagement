...
class HolidayForm extends sfForm {
    ...
    public function setDefaultValues($holidayId) {
        ...
        if ($holidayObject instanceof Holiday) {
            ...
            // kartik new created for holiday            
            $chkCompensate = $holidayObject->getCompensate() == '1' ? true : false;            
            // kartik new created for holiday
            ...
            // kartik new created for holiday            
            $this->setDefault('compensate', $chkCompensate);            
            // kartik new created for holiday
    ...
    protected function getFormWidgets() {
        ...
        // kartik new created for holiday 
         $widgets['compensate'] = new sfWidgetFormInputCheckbox(array(), array(
                    'class' => 'formCheckbox',
                ));
        // kartik new created for holiday 
    ...
    protected function getFormValidators() {
        ...
        // kartik new created for holiday
        $validators['compensate'] = new sfValidatorString(array('required' => false));
        // kartik new created for holiday
    ...
    protected function getFormLabels() {
        ...
        // kartik new created for holiday
        $labels['compensate'] = __('Compensate');
        // kartik new created for holiday
