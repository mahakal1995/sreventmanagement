...
// kartik new created for holiday                 
                if ($this->editMode) {
                    ...
                    if ($date != $holidayObjectDate->getDate() && $holidayObjectDate->getCompensate()) {
                        $allowToAdd = false;
                    }
                } else {
                    /* Days already added can not be selected to add */
                    if ($date == $holidayObjectDate->getDate() || $holidayObjectDate->getCompensate() == 1) {
                        $allowToAdd = false;
                    }
                }
// kartik new created for holiday                 
...
// kartik new created for holiday                         
                    $compensateValue = $post['compensate'] == 'on' ? 1 : 0;
                    $holidayObject->setCompensate($compensateValue);
// kartik new created for holiday                         
