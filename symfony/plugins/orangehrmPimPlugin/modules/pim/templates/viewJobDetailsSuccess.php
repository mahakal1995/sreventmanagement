...
<!--                                          kartik -->
                                          <br class="clear"/>                                  
                                  <?php echo $form['rate_per_hours']->renderLabel(__('Rate Per Hours')); ?>        
                                  <?php echo $form['rate_per_hours']->render(array("maxlength" => 5)) ?>                                          
                                          <br class="clear"/>
<!--                                          kartik -->
...
<?php } ?>
                                      ...
                                      '#job_joined_date', '#job_sub_unit', '#job_location','#job_rate_per_hours',
