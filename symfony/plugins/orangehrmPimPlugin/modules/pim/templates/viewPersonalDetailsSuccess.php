...
if($_SESSION['index_patch']==1)
{
  header("Location: ../time/viewMyTimesheet?timesheetStartDateFromDropDown=".$_SESSION['index_start_date']."&employeeId=".$_SESSION['index_empid']);
  exit;
//  ========================
}
