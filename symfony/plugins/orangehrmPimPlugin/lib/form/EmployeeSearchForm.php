...
class EmployeeSearchForm extends BaseForm {
    ...
    // Rushika Changes = object $jobCategoryService is declared
...
// Rushika Changes = _setJobCategoryWidget and getJobCategoryService is declared
    public function _setJobCategoryWidget()
    {
      $jobTitleList = $this->getJobCategoryService()->getJobCategoryList();
        $choices = array('0' => __('All'));
        foreach ($jobTitleList as $job) {
            $choices[$job->getId()] = $job;
        }
    ...
    public function getJobCategoryService() {
        if (is_null($this->jobCategoryService)) {
            ...
            $this->jobCategoryService->setJobCategoryDao(new JobCategoryDao());
...
// Rushika Changes = _setJobCategoryWidget() instead of _setJobTitleWidget
//         $this->_setJobTitleWidget();
        $this->_setJobCategoryWidget();
