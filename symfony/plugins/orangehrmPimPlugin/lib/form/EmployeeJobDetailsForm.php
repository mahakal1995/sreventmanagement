...
//            kartik
            'rate_per_hours' => new sfWidgetFormInputText(),
//            kartik
...
//        kartik
        $this->setDefault('rate_per_hours', ($employee->rate_per_hours));
//        kartik        
...
//            kartik
            ...
            'rate_per_hours' => new sfValidatorString(array('required' => false, 'max_length' => 5), array('max_length' => 'Rate per hours No length exceeded 5 characters')),
...
//        kartik
        $employee->rate_per_hours = $this->getValue('rate_per_hours');
//        kartik        
