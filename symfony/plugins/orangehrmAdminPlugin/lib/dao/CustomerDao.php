...
//        private function _undeleteRelativeProjectDiuForProject($projectId) {
//
//        try {
//            $q = Doctrine_Query :: create()
//                    ->from('ProjectDiu')
//                    ->where('is_deleted = ?', ProjectDiu::DELETED_PROJECT_DIU)
//                    ->andWhere('project_id = ?', $projectId);
//            $projectDius = $q->execute();
//
//            foreach ($projectDius as $projectDiu) {
//                $projectDiu->setIsDeleted(ProjectDiu::ACTIVE_PROJECT_DIU);
//                $projectDiu->save();
//            }
//        } catch (Exception $e) {
//            throw new DaoException($e->getMessage());
