...
class ProjectService extends BaseService {
	...
	public function deleteProjectActivities($activityId) {
		...
		return $this->projectDao->deleteProjectDius($diuId);
	}
...
// kartik new created for diu        
        public function getProjectDiuById($projectId) {
		return $this->projectDao->getProjectDiuById($projectId);
	}
// kartik new created for diu        
        

// kartik new created for list for activity module        
          public function getDiuList($projectId) {
		return $this->projectDao->getDiuList($projectId);
	}
// kartik new created for activity module               
	/**
	 *
	 * Get all projects
	 * 
...
// kartik new created for diu
		...
		return $this->projectDao->getDiuListByProjectId($projectId);
	}
// kartik new created for diu
...
// kartik new created for diu        
//        public function hasDiuGotTimesheetItems($diuId) {
//		return $this->projectDao->hasDiuGotTimesheetItems($diuId);
//	}
// kartik new created for diu        
