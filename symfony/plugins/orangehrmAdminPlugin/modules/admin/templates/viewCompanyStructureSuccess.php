...
<div id="dltDialog" title="<?php echo __("HRM - Confirmation Required"); ?>"  style="display:none;">
    <br class="clear"/>
...
<script type="text/javascript">
    ...
    var lang_addUnit = "<?php echo "HRM - ".__("Add Unit"); ?>";
    var lang_editUnit = "<?php echo "HRM - ".__("Edit Unit"); ?>";
