...
//            $this->diuForm = new AddProjectDiuForm();            
////            $this->copyActForm = new CopyDiuForm();            
//            $this->diuList = $this->getProjectService()->getDiuListByProjectId($this->projectId);
//            $this->_setListComponentDiu($this->diuList);
//            $paramsDiu = array();
//            $this->parmetersForListCompomentDiu = $paramsDiu;                         
//        }
// kartik new created for diu
...
//        echo "<pre>"; print_r($customerList);  echo "</pre>";
...
//        ohrmListComponent::setListData($customerList);
    ...
    private function _setListComponentDiu($customerList, $noOfRecords, $pageNumber) {
        // kartik new created for diu
        $configurationFactory = new ProjectDiuHeaderFactory();
        ohrmListComponent::setConfigurationFactory($configurationFactory);
        ohrmListComponent::setListData($customerList);
