...
//Date:2014-03-21    
//Purpose:Add new menu for erp report    
        const HRM_REPORT_LINK="hrm_report.php";
        const ERP_REPORT_LINK="erp_report.php";
	...
	public function getAccessibleReportSubMenus() {
		...
		$topMenuItem->setLink(AdminUserRoleDecorator::ATTENDANCE_TOTAL_SUMMARY_REPORT_LINK);
                ...
                $topMenuItem = new TopMenuItem();
		$topMenuItem->setDisplayName(__("TIMESHEET Report"));
		$topMenuItem->setLink(AdminUserRoleDecorator::HRM_REPORT_LINK);
...
//Purpose:Add new menu for erp report                
                 $topMenuItem = new TopMenuItem();
		$topMenuItem->setDisplayName(__("ERP Report"));
		$topMenuItem->setLink(AdminUserRoleDecorator::ERP_REPORT_LINK);
