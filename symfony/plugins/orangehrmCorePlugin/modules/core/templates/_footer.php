...
<div id="divFooter" >
    <span id="spanCopyright">
        <a href="http://www.inextrix.com" target="_blank">HRM System </a> 
        ver <?php echo $version; ?> &copy; iNextrix Technologies 2010 - <?php echo $copyrightYear; ?> All rights reserved.
    </span>
