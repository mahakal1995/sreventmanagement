...
if(!function_exists('renderActionBar'))
{
...
if(!function_exists('printAssetPaths'))
{
...
if(!function_exists('printButtonEventBindings'))
{
...
<!--   kartik all list comes -->
            <tbody>
                <?php
                    if (is_object($data) && $data->count() > 0) {
                        $rowCssClass = 'even';
//echo "<pre>";print_r($data['estimate_time']);
