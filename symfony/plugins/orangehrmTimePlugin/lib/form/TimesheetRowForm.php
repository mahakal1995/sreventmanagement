...
class TimesheetRowForm extends sfForm {
    ...
    /**        
        By:kartik gondalia
        Date:23-03-2013
        Purpose:change size and width for OT
        Keep Original line here if:-
    */
        $this->widgetSchema['projectName']->setAttribute('size', 23);
        $this->setDefault('projectName', __('Type for hints').'...');
        $this->widgetSchema['projectActivityName']->setAttribute('style', 'width:120px');
/*==================================================================================================*/
	for ($i = 0; $i < $noOfDays; $i++) {
