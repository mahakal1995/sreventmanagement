...
$(document).ready(function() {
    ...
    $('#btnAddRow').click(function(){
        $("#extraRows").append(addRow(rows-1,startDate,endDate,employeeId,timesheetId,currentWeekDates));
        rows = rows + 1;
    });
...
function addRow(num,startDate,endDate,employeeId,timesheetId,currentWeekDates) {
...
// kartik
    ...
    var r = $.ajax({
        type: 'GET',
        url: link ,
        data: "num="+num+"&startDate="+startDate+"&endDate="+endDate+"&employeeId="+employeeId+"&timesheetId="+timesheetId+"&currentWeekDates="+currentWeekDates,
        async: false
    }).responseText;
    return r;
