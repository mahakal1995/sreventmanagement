...
//$proj_query="SELECT project_id,name FROM project WHERE ".$proj_where." order by t1.name ASC";
// echo $proj_query;
$proj_result =mysql_query($proj_query);
if($proj_result)
{
...
//======================================================================
//        working on firefox but need to give file name
//        window.open('data:application/vnd.ms-excel,' + encodeURIComponent(document.getElementById('tbl-1').outerHTML));
//======================================================================
}
function resetdiv()
{
