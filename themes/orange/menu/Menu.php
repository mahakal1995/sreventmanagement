...
<?php							
							...
							foreach($subSubItems as $subSub) {
							   ...
							   if($link=="./inextrix/index.php?action=otconfig")
  $target = 'target="rightMenu"';
 else
...
//Date:2014-03-21
//Purpose:open the report in new tab    
?>
						<li class="l3">
							<a href="<?php echo $link; ?>" onclick="menuclicked(this);" class="<?php echo $class; ?>" <?php if($link=="hrm_report.php" || $link=="erp_report.php"){?>target="_blank"<?}else{echo $target;} ?> >
